...
/**
 * Klasse die generieke databewerkingen (inclusief de daarvoor benodigde exceptieafhandeling) voor 
 * theater's data laag: theaterdata bevat. Deze klasse is bedoeld 
...
public abstract class TheaterDatabeheer {
	 ...
	 * @param sqlDatum:  formaat is Date
	 ...
	 * @param datum in gregorian calendar formaat
	 * @return datum in formaat dd-mm-yyyy
	 */
	public static String geefDmjDatum(GregorianCalendar datum){
		SimpleDateFormat datumFormaat = new SimpleDateFormat("dd-MM-yyyy");
		String dmjDatum = datumFormaat.format(datum.getTime());
		return (dmjDatum.toString());
	}
	/**
